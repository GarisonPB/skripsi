      ...
      <section class="ftco-section ">
        <div class="container">
          ...
          <?php if ($this->session->flashdata('error')) {?>
              ...
              <?php }?>
                <form method ="post" action="<?php echo base_url('login/cek_login');?>" class=" p-3 p-md-5 bg-primary">
                ...
                <div class="form-group">
                  <button href="<?php echo base_url('login/ceklogin');?>" type="submit"  name="login" class="btn bg-success btn-lg btn-block">Login</button> </div>
          </center>
        </div>
      </form>
    </div>
